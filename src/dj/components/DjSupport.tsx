...
const FAQ_DATA: FAQ[] = [
  ...
  { question: 'Какова комиссия платформы?', answer: 'Комиссия Promo.music составляет 10% с каждого букинга. Питчинг и загрузка миксов - бесплатно. Баннерная реклама оплачивается отдельно по выбранному тарифу.', category: 'Финансы' },
];

...
const FAQ_DATA: FAQ[] = [
  ...
  { question: 'Как настроить публичный профиль?', answer: 'Перейдите в раздел "Профиль". Заполните биографию, добавьте фото, укажите жанры и город. Чем полнее профиль, тем выше ваш рейтинг и видимость в DJ Маркетплейс.', category: 'Профиль' },

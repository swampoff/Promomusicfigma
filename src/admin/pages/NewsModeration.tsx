...
export function NewsModeration() {
  ...
  const demoNews: NewsItem[] = [
    {
      id: 1,
      title: 'Мой трек попал в ротацию через Promo.Air',
      author: 'Александр Иванов',
      authorAvatar: 'https://i.pravatar.cc/150?img=12',
      category: 'Релиз',
      uploadDate: '2026-03-09T14:30:00',
      status: 'pending',
      likes: 0,
      comments: 0,
      views: 0,
      cover: 'https://images.unsplash.com/photo-1478737270239-2f02b77fc618?w=800',
      content: 'Отправил трек через питчинг на Promo.Music и получил одобрение от радиостанции! Модуль Promo.Air реально работает — трек уже в ротации. Делюсь впечатлениями от первого опыта.',
      userId: 'user_123',
      isPaid: false,
    },
    {
      id: 2,
      title: 'Записала новый сингл с продюсером из Promo.Lab',
      author: 'Мария Петрова',
      authorAvatar: 'https://i.pravatar.cc/150?img=5',
      category: 'Студия',
      uploadDate: '2026-03-08T10:15:00',
      status: 'pending',
      likes: 0,
      comments: 0,
      views: 0,
      cover: 'https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=800',
      content: 'Нашла продюсера через Promo.Lab и за неделю записали потрясающий трек. AI-помощник помог со сведением. Это один из самых личных треков, который я когда-либо писала.',
      userId: 'user_456',
      isPaid: true,
    },
    {
      id: 3,
      title: 'Весенний тур: добавлены концерты в Казани и Екатеринбурге',
      author: 'Дмитрий Соколов',
      authorAvatar: 'https://i.pravatar.cc/150?img=33',
      category: 'Концерты',
      uploadDate: '2026-03-07T16:45:00',
      status: 'approved',
      likes: 247,
      comments: 38,
      views: 1542,
      cover: 'https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?w=800',
      content: 'Добавил новые даты весеннего тура! Казань — 4 апреля (Казань Экспо), Екатеринбург — 10 апреля (МТС Live Холл). Билеты уже в продаже через Promo.Music.',
      userId: 'user_789',
      isPaid: true,
    ...
    {
      id: 4,
      title: 'Почему Promo.Music лучше других площадок для продвижения',
      author: 'Сергей Волков',
      authorAvatar: 'https://i.pravatar.cc/150?img=68',
      category: 'Мнение',
      uploadDate: '2026-03-06T09:20:00',
      status: 'rejected',
      likes: 0,
      comments: 0,
      views: 0,
      cover: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=800',
      moderationNote: 'Содержит оскорбительные высказывания в адрес других платформ и нецензурную лексику',
      content: 'Хочу высказаться о том, почему Promo.Music — единственная нормальная платформа...',
      userId: 'user_101',
      isPaid: false,
    },
    {
      id: 5,
      title: 'Коллаборация с продюсером из Promo.Lab — первые детали',
      author: 'Александр Иванов',
      authorAvatar: 'https://i.pravatar.cc/150?img=12',
      category: 'Коллаборация',
      uploadDate: '2026-03-05T11:10:00',
      status: 'pending',
      likes: 0,
      comments: 0,
      views: 0,
      cover: 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=800',
      content: 'Через биржу битов в Promo.Lab нашёл идеального продюсера для нового проекта. Работаем над треком, который планирую отправить через питчинг на радио.',
      userId: 'user_123',
      isPaid: true,
    },
    {
      id: 6,
      title: 'Спасибо за поддержку на концерте в Краснодаре!',
      author: 'Анна Смирнова',
      authorAvatar: 'https://i.pravatar.cc/150?img=9',
      category: 'Концерты',
      uploadDate: '2026-03-07T15:00:00',
      status: 'approved',
      likes: 892,
      comments: 124,
      views: 3456,
      cover: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800',
      content: 'Концерт в Баскет-Холле прошёл невероятно! Полный зал, потрясающая энергетика. Спасибо Краснодару и команде Promo.Music за промо-поддержку!',
      userId: 'user_202',
      isPaid: false,
    },
    {
      id: 7,
      title: 'Благотворительный концерт в Доме музыки — 20 марта',
      author: 'Оркестр «Гармония»',
      authorAvatar: 'https://i.pravatar.cc/150?img=14',
      category: 'Благотворительность',
      uploadDate: '2026-03-04T12:30:00',
      status: 'pending',
      likes: 0,
      comments: 0,
      views: 0,
      cover: 'https://images.unsplash.com/photo-1511379938547-c1f69419868d?w=800',
      content: '20 марта состоится благотворительный концерт в Московском Доме музыки. Все средства от продажи билетов пойдут на помощь детям. Приглашаем всех неравнодушных!',
      userId: 'user_303',
      isPaid: false,
    },
  ];
  ...
  return (
    <div className="space-y-3 xs:space-y-4 md:space-y-6 px-0 xs:px-1 md:px-0">
      ...
      >
        {/* Title & Stats */}
        <div className="flex flex-col gap-2.5 xs:gap-3 mb-3 xs:mb-4 md:mb-6">
          <div className="flex items-center gap-2 xs:gap-3 md:gap-4">
            <div className="p-1.5 xs:p-2 md:p-3 rounded-lg xs:rounded-xl md:rounded-2xl bg-gradient-to-br from-blue-500/20 to-cyan-500/20 border border-blue-500/30 flex-shrink-0">
              <FileText className="w-4 h-4 xs:w-5 xs:h-5 md:w-8 md:h-8 text-blue-400" />
            </div>
            <div className="flex-1 min-w-0">
              <h1 className="text-base xs:text-lg md:text-3xl font-bold text-white truncate">Модерация новостей</h1>
              <p className="text-[10px] xs:text-xs md:text-base text-gray-400 truncate">Проверяйте и одобряйте публикации</p>
            </div>
          </div>

          {/* Quick Stats */}
          <div className="grid grid-cols-2 gap-1.5 xs:gap-2">
            <div className="px-2 xs:px-2.5 md:px-3 py-1 xs:py-1.5 md:py-2 rounded-lg bg-yellow-500/10 border border-yellow-500/20 text-center">
              <div className="text-[10px] xs:text-xs text-gray-400">Ожидают</div>
              <div className="text-sm xs:text-base md:text-xl font-bold text-yellow-400">{stats.pending}</div>
            </div>
            <div className="px-2 xs:px-2.5 md:px-3 py-1 xs:py-1.5 md:py-2 rounded-lg bg-green-500/10 border border-green-500/20 text-center">
              <div className="text-[10px] xs:text-xs text-gray-400">Одобрено</div>
              <div className="text-sm xs:text-base md:text-xl font-bold text-green-400">{stats.approved}</div>
            </div>
          </div>
        </div>
        ...
        {allNews.length === 0 && (
          <div className="mb-3 xs:mb-4 p-2.5 xs:p-3 md:p-4 rounded-lg xs:rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-start gap-2 xs:gap-3">
            ...
            <div className="flex-1">
              <h3 className="text-[10px] xs:text-xs md:text-sm font-semibold text-blue-400 mb-0.5 xs:mb-1">Демонстрационные новости</h3>
        ...
        {/* Search & Filters */}
        <div className="space-y-2 xs:space-y-2.5 md:space-y-3">

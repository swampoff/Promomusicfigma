      ...
      >
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3 xs:gap-4 mb-3 xs:mb-4 md:mb-6">
          <div className="flex items-center gap-2.5 xs:gap-3 md:gap-4">
            <div className="p-1.5 xs:p-2 md:p-3 rounded-lg xs:rounded-xl md:rounded-2xl bg-gradient-to-br from-red-500/20 to-pink-500/20 border border-red-500/30">
              <Video className="w-5 h-5 xs:w-6 xs:h-6 md:w-8 md:h-8 text-red-400" />
            </div>
            <div>
              <h1 className="text-lg xs:text-xl md:text-3xl font-bold text-white">Модерация видео</h1>
              <p className="text-[10px] xs:text-xs md:text-base text-gray-400">Проверяйте и одобряйте видеоконтент</p>
            </div>
          </div>
        ...
        {allVideos.length === 0 && (
          <div className="mb-3 xs:mb-4 p-2.5 xs:p-3 md:p-4 rounded-lg xs:rounded-xl bg-blue-500/10 border border-blue-500/20 flex items-start gap-2 xs:gap-3">
            ...
            <div className="flex-1">
              <h3 className="text-[10px] xs:text-xs md:text-sm font-semibold text-blue-400 mb-0.5 xs:mb-1">Демонстрационные видео</h3>
          ...
          <div className="flex flex-col sm:flex-row gap-1.5 xs:gap-2 md:gap-3">
            ...
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-9 xs:pl-10 md:pl-12 pr-3 xs:pr-4 py-2 xs:py-2.5 md:py-3 rounded-lg md:rounded-xl bg-white/5 border border-white/10 text-white text-xs xs:text-sm md:text-base placeholder-gray-400 focus:outline-none focus:border-red-500/50 transition-all"
              />
            </div>

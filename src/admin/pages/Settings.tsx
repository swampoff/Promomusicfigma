...
export function AdminSettings() {
  ...
  const [settings, setSettings] = useState({
    ...
    termsOfServiceUrl: '/user-agreement',
  ...
  const settingsSections: Record<string, SettingsSection[]> = {
    ...
    payments: [
      ...
      },
      {
        ...
        fields: [
          {
            label: 'Включить Т-Банк',
            type: 'toggle',
            value: settings.tbankEnabled,
            onChange: (v) => updateSetting('tbankEnabled', v),
          },
          {
            label: 'Terminal Key',
            type: 'text',
            value: settings.tbankTerminalKey,
            onChange: (v) => updateSetting('tbankTerminalKey', v),
            placeholder: 'terminal_xxxxx',
            disabled: !settings.tbankEnabled,
          },
          {
            label: 'Secret Key',
            type: 'password',
            value: settings.tbankSecretKey,
            onChange: (v) => updateSetting('tbankSecretKey', v),
          ...
          },
          {
            label: 'Webhook URL',
            type: 'text',
            value: settings.tbankWebhookUrl,
            onChange: (v) => updateSetting('tbankWebhookUrl', v),
            placeholder: 'https://...',
            disabled: !settings.tbankEnabled,
          },
        ],
        ...
        fields: [
          {
            ...
            type: 'toggle',
            value: settings.yukassaEnabled,
            onChange: (v) => updateSetting('yukassaEnabled', v),
          },
          {
            label: 'Shop ID',
            type: 'text',
            value: settings.yukassaShopId,
            onChange: (v) => updateSetting('yukassaShopId', v),
            placeholder: '123456',
            disabled: !settings.yukassaEnabled,
          },
          {
            label: 'Secret Key',
            type: 'password',
            value: settings.yukassaSecretKey,
            onChange: (v) => updateSetting('yukassaSecretKey', v),

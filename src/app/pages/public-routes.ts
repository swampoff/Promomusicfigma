...
export const publicRoutes: RouteObject[] = [
  ...
  { path: 'for-venues', lazy: () => import('./public-pages').then((m) => ({ Component: m.ForVenuesRoute })) },
  ...
  { path: 'radio-stations', lazy: () => import('./public-pages').then((m) => ({ Component: m.ForBusinessRoute })) },
  ...
  { path: 'news/:id', lazy: () => import('./public-pages').then((m) => ({ Component: m.NewsDetailRoute })) },
  { path: 'marketplace', lazy: () => import('./public-pages').then((m) => ({ Component: m.MarketplaceRoute })) },
  { path: 'pricing', lazy: () => import('./public-pages').then((m) => ({ Component: m.PricingRoute })) },
  { path: 'djs', lazy: () => import('./public-pages').then((m) => ({ Component: m.DjCatalogRoute })) },
  { path: 'djs/:id', lazy: () => import('./public-pages').then((m) => ({ Component: m.DjPublicProfileRoute })) },
  { path: 'faq', lazy: () => import('./public-pages').then((m) => ({ Component: m.FaqRoute })) },
  ...
  { path: 'investors', lazy: () => import('./public-pages').then((m) => ({ Component: m.InvestorsRoute })) },
];

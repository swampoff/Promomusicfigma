...
export function SEO({
  title = 'ПРОМО.МУЗЫКА - Профессиональный кабинет артиста',
  ...
  image = 'https://promo-music.ru/og-image.jpg',
  url = 'https://promo-music.ru',
  type = 'website',
  author,
  publishedTime,
  modifiedTime,
...
export const SEOConfig = {
  ...
  trackTest: {
    title: 'Тест трека - Профессиональная оценка экспертами | ПРОМО.МУЗЫКА',
  ...
  concerts: {
    title: 'Мои концерты - ПРОМО.МУЗЫКА',
  ...
  promotion: {
    title: 'Продвижение - ПРОМО.МУЗЫКА',
  ...
  banners: {
    title: 'Баннерная реклама - ПРОМО.МУЗЫКА',

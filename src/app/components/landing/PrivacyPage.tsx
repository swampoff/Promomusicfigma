  ...
  const sections = [
    {
      ...
      content: [
        ...
        'Платежная информация обрабатывается через защищенные платежные системы (Stripe, PayPal).'
      ]
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        'Платежные системы: Stripe, PayPal (соответствуют PCI DSS).',
    ...
    },
    {
      ...
      icon: Shield,
      content: [
        'Ваши данные могут обрабатываться в США, ЕС, Великобритании.',
        'Мы используем Standard Contractual Clauses (SCC) для передачи данных из ЕС.',
        'Все провайдеры соответствуют GDPR и другим международным стандартам.',
        'При передаче данных применяются дополнительные меры защиты.'
      ]
    },
    {
    ...
    },
    {
      ...
      content: [
        ...
        'Дата последнего обновления: 07 февраля 2026 года.',
  ...
  const highlights = [
    {
      ...
      description: 'Полное соответствие европейскому регламенту'
    },
    {
      icon: Lock,
      title: 'SSL 256-bit',
    ...
    },
    {
      icon: Database,
      title: 'ISO 27001',
      description: 'Сертифицированная безопасность'
    },
    {
      icon: UserCheck,
      title: 'Ваши права',

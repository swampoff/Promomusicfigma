...
const FALLBACK_CONCERTS: NormalizedConcert[] = [
  {
    id: 'mock-1', title: 'Toxi$ — Большой сольный концерт', artist: 'Toxi$', date: '2026-03-14', time: '19:00',
    venue: 'VK Stadium', city: 'Москва',
    coverImage: 'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=800',
    ticketPriceFrom: '2000', ticketPriceTo: '8000', capacity: 8000, ticketsSold: 5200,
    source: 'promo_artist',
  },
  {
    id: 'mock-2', title: 'Григорий Лепс — Большой концерт', artist: 'Григорий Лепс', date: '2026-03-09', time: '19:00',
    venue: 'БКЗ «Октябрьский»', city: 'Санкт-Петербург',
    coverImage: 'https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?w=800',
    ticketPriceFrom: '2500', ticketPriceTo: '7000', capacity: 4000, ticketsSold: 2800,
    source: 'promo_artist',
  },
  {
    id: 'mock-3', title: 'Артур Пирожков — Шоу', artist: 'Артур Пирожков', date: '2026-04-04', time: '19:00',
    venue: 'МВЦ «Казань Экспо»', city: 'Казань',
    coverImage: 'https://images.unsplash.com/photo-1540039155733-5bb30b53aa14?w=800',
    ticketPriceFrom: '2000', ticketPriceTo: '6000', capacity: 5000, ticketsSold: 3100,
    source: 'promo_artist',
  },
  {
    id: 'mock-4', title: 'Metallica Show S&M Tribute', artist: 'Симфонический оркестр', date: '2026-04-02', time: '19:00',
    venue: 'Киноконцертный театр «Космос»', city: 'Екатеринбург',
    coverImage: 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800',
    ticketPriceFrom: '2500', ticketPriceTo: '6000', capacity: 2500, ticketsSold: 1600,
    source: 'promo_artist',
  },
  {
    id: 'mock-5', title: 'Мари Краймбрери — Концерт', artist: 'Мари Краймбрери', date: '2026-03-06', time: '20:00',
    venue: 'Баскет-Холл', city: 'Краснодар',
  ...
  {
    id: 'mock-6', title: 'Flo Rida — Live in Russia', artist: 'Flo Rida', date: '2026-03-14', time: '20:00',
    venue: 'СК «Сибирь-Арена»', city: 'Новосибирск',
    coverImage: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=800',
    ticketPriceFrom: '4400', ticketPriceTo: '12000', capacity: 5000, ticketsSold: 3500,
    source: 'promo_artist',
  },
];

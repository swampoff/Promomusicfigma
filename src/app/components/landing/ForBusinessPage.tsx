...
export function ForBusinessPage({ onGetStarted }: ForBusinessPageProps) {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      a: 'Радиостанция получает доход двумя способами: рекламные слоты (аудиореклама заведений, ресторанов, брендов, мероприятий) и спонсорство эфира (артисты и лейблы платят за гарантированные ротации). Вы управляете расписанием, ценообразованием и объёмом рекламы через рекламный кабинет станции.',
    },
    {
      q: 'Какие гарантии правовой чистоты треков?',
      a: 'Все артисты при загрузке подтверждают владение правами и дают согласие на эфирное использование. Каждый трек сопровождается лицензионным соглашением. Платформа работает с верифицированными артистами, продюсерами и лейблами.',
    },
    {
      q: 'Сколько стоят рекламные слоты для заведений?',
      a: 'Ценообразование устанавливает сама радиостанция через рекламный кабинет. Вы контролируете стоимость слотов, расписание размещения и объём рекламы. Платформа не берёт комиссий с рекламного дохода — весь заработок остаётся у станции.',
    },
    {
      q: 'Что такое подбор треков по Camelot wheel?',
      a: 'Camelot wheel — система гармонического микширования. Платформа автоматически подбирает треки, совместимые по тональности, чтобы переходы звучали плавно и профессионально. Плюс учитывается кривая энергии 24 часа — ночью спокойнее, днём энергичнее.',
    },
    {
      q: 'Можно ли запустить интернет-радио с нуля?',
      a: 'Да. ПРОМО.ЭИР — встроенный стриминг-сервер, позволяющий запустить полноценное интернет-радио за 5 минут: автоматическая ротация треков, расписание по времени суток, встроенный плеер для сайта. Не нужен свой сервер — всё работает на платформе.',
    },
    {
      q: 'Какие данные аналитики радиоэфира доступны?',
      a: 'Кабинет станции включает: статистику прослушиваний в реальном времени, популярные треки и жанры, географию и демографию аудитории, эффективность ротации каждого трека, отчёты для рекламодателей с подтверждением выходов рекламы, экспорт в CSV и PDF.',
    },
    {
      q: 'С какими системами вещания работает API?',
      a: 'REST API интегрируется с любой системой автоматизации вещания: AzuraCast, mAirList, RadioBOSS, ZaraRadio, SAM Broadcaster и другие. API позволяет получать плейлисты, треки, метаданные и статистику автоматически.',
    },
    {
      q: 'Подходит ли платформа для фоновой музыки в кафе и ресторанах?',
      a: 'Да. Через ПРОМО.ЭИР можно организовать фоновую музыку для бизнеса: кафе, рестораны, магазины, торговые центры. Автоматический подбор по настроению и времени суток, кастомные плейлисты по формату заведения.',
    },
    {
      q: 'Как артисту попасть в эфир радиостанции?',
      a: 'Артист регистрируется на ПРОМО.МУЗЫКА, загружает трек с метаданными (жанр, BPM, тональность) — трек автоматически попадает в каталог для 500+ радиостанций. Станции фильтруют по формату и добавляют в ротацию. Продвижение музыки на радио доступно для начинающих артистов.',
    },
  ];
  ...
  const timelineSteps = [
    ...
    { icon: Settings, label: 'Настройка формата', sub: 'Жанры, BPM, регион, Camelot' },
    { icon: Send, label: 'Приём треков', sub: 'Бесплатная музыка от артистов' },
    { icon: Radio, label: 'В эфир', sub: 'Автоматическая ротация + реклама' },
    { icon: BarChart3, label: 'Доход и аналитика', sub: 'Монетизация + статистика эфира' },
  ];

  const coreFeatures = [
    {
      icon: DollarSign,
      title: 'Монетизация радиоэфира — заработок на интернет-радио',
      desc: 'Продавайте рекламные слоты заведениям, ресторанам и брендам через рекламный кабинет станции',
      points: ['Рекламные слоты по времени суток и дням недели', 'Спонсорство эфира от артистов и лейблов', 'Автоматические выплаты без комиссий', 'Отчёты для рекламодателей с доказательством размещения'],
      accent: 'cyan',
    },
    {
      icon: Music,
      title: 'Свежие треки от артистов — прямо в ротацию',
      desc: 'Артисты сами загружают контент для промо-размещения — вы получаете качественные треки под формат станции',
      points: ['Фильтрация по жанру, BPM, настроению, тональности', 'Модерация и система рейтингов качества', 'Рекомендации треков под формат станции', 'Прямой чат с артистами и лейблами'],
      accent: 'teal',
    },
    {
      icon: PieChart,
      title: 'Аналитика радиоэфира — статистика прослушиваний',
      desc: 'Детальные данные: кто слушает, что популярно, когда пик аудитории, эффективность ротации',
      points: ['Статистика прослушиваний в реальном времени', 'География и демография аудитории', 'Данные для рекламодателей с подтверждением выходов', 'Экспорт аналитики в CSV и PDF'],
      accent: 'blue',
    },
    {
      icon: Zap,
      title: 'Автоматизация вещания и подбор треков',
      desc: 'Автоматический подбор треков по энергии и гармонии (Camelot wheel), интеллектуальные плейлисты 24/7',
      points: ['Гармонический микс по системе Camelot', 'Автоплейлисты по кривой энергии 24 часа', 'Автоматическая ротация по расписанию', 'Интеграция с ПРОМО.ЭИР стриминг-сервером'],
      accent: 'indigo',
    },
  ];
  ...
  const extraTools = [
    ...
    { icon: MessageSquare, label: 'Чат с артистами' },
    { icon: Activity, label: 'Аналитика в реальном времени' },
    { icon: Volume2, label: 'Стриминг-сервер 24/7' },
    { icon: Award, label: 'Рейтинг станции в каталоге' },
  ];

  const radioStats = [
    { icon: Radio, value: '500+', label: 'Радиостанций на платформе', color: 'text-purple-400' },
    { icon: Music, value: '5 000+', label: 'Треков для эфира', color: 'text-violet-400' },
    { icon: Users, value: '150K+', label: 'Слушателей в сети', color: 'text-indigo-400' },
    { icon: Zap, value: '24/7', label: 'Автономное вещание', color: 'text-fuchsia-400' },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#0a0a14] text-white">
      ...
      <section className="relative w-full h-[50vh] sm:h-[60vh] lg:h-[65vh] xl:h-[70vh] max-h-[700px] overflow-hidden bg-black">
        ...
        <motion.img
          src={radioHeroImage}
          alt="Монетизация радиоэфира — рекламные слоты, аналитика, автоматическое вещание | ПРОМО.МУЗЫКА"
        ...
        <div className="absolute bottom-8 sm:bottom-12 left-0 right-0 px-3 sm:px-5 lg:px-6">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}>
            ...
            <h1 className="text-3xl xs:text-4xl sm:text-5xl xl:text-6xl font-black leading-tight max-w-4xl">
              ...
              >
                монетизация эфира и аналитика
              </motion.span>
            </h1>
            <p className="text-sm sm:text-base text-gray-300 mt-3 max-w-2xl">
              Автономное радиовещание 24/7. Свежий контент от артистов, заработок на рекламных слотах
              для заведений и детальная аналитика радиоэфира — всё в одной платформе.
            </p>
            <motion.button
      ...
      <section className="py-6 sm:py-10 px-3 sm:px-5 lg:px-6">
        <motion.h2 initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}
          className="text-xl sm:text-2xl font-black text-center mb-6">
          Монетизация, аналитика и автоматизация <span className="text-purple-400">для радиостанций</span>
        </motion.h2>
      ...
      <section className="py-4 sm:py-6 px-3 sm:px-5 lg:px-6">
        <motion.p initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}
          className="text-xs text-gray-500 text-center mb-3">Дополнительные инструменты для автономного вещания:</motion.p>
      ...
      <section className="py-6 sm:py-10 px-3 sm:px-5 lg:px-6">
        <motion.h2 initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}
          ...
          Калькулятор <span className="text-purple-400">заработка на интернет-радио</span>
        </motion.h2>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          ...
          <p className="text-xs text-gray-400 mb-4">
            Рассчитайте потенциальный заработок на интернет-радио: доход от рекламных слотов для заведений и спонсорского размещения треков через ПРОМО.МУЗЫКА.
          </p>
      ...
      <section className="py-6 sm:py-10 px-3 sm:px-5 lg:px-6">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          ...
          <h2 className="text-base lg:text-lg font-black text-white mb-4 flex items-center gap-2">
            ...
            Бесплатное продвижение музыки + монетизация радиоэфира
          </h2>
          ...
          <div className="grid sm:grid-cols-2 gap-3 lg:gap-4">
            ...
            <div className="bg-white/5 rounded-xl p-3 lg:p-4 border border-white/5">
              ...
              <div className="space-y-1.5">
                {['Свежий контент от артистов и лейблов', 'Заработок на рекламных слотах для заведений', 'Аналитика радиоэфира в реальном времени', 'Автоматизация ротации и расписания', 'Подбор треков по гармонии (Camelot)'].map((item, i) => (
                  <div key={i} className="flex items-start gap-1.5 text-[10px] lg:text-xs text-gray-300">
            ...
            <div className="bg-white/5 rounded-xl p-3 lg:p-4 border border-white/5">
              ...
              <div className="space-y-1.5">
                {['Попадание на 500+ радиостанций', 'Трекинг ротаций и статистика прослушиваний', 'Продвижение треков для начинающих артистов', 'Рост аудитории через радиоэфир', 'Обратная связь от музыкальных редакторов'].map((item, i) => (
                  <div key={i} className="flex items-start gap-1.5 text-[10px] lg:text-xs text-gray-300">
          ...
          <div className="relative bg-gradient-to-br from-purple-500/[0.08] to-violet-500/[0.08] backdrop-blur-sm rounded-2xl p-5 lg:p-6 border-2 border-purple-500/30 ring-2 ring-purple-500/10 ring-offset-2 ring-offset-[#0a0a14]">
            ...
            <div className="grid grid-cols-2 gap-x-3 gap-y-2 mb-5">
              {[
                ...
                'Монетизация эфира через рекламные слоты',
                'Детальная аналитика радиоэфира',
                'Автоматизация ротации (Camelot)',
                'REST API для системы вещания',
                'Публичный профиль в каталоге станций',
                'Техническая поддержка 24/7',
                'Без комиссий с рекламного дохода'
              ].map((feature, i) => (
                <div key={i} className="flex items-start gap-1.5 text-[10px] lg:text-xs text-gray-300">
                  <CheckCircle2 className="w-3 h-3 text-purple-400 flex-shrink-0 mt-0.5" />
                  <span>{feature}</span>
      ...
      <section className="py-6 sm:py-10 px-3 sm:px-5 lg:px-6 pb-12 sm:pb-16">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
          ...
          <p className="text-xs lg:text-sm text-gray-400 mb-5 max-w-lg mx-auto">
            Получайте свежие треки от артистов, зарабатывайте на рекламных слотах для заведений
            и управляйте эфиром с детальной аналитикой — зарегистрируйтесь за 2 минуты.
          </p>

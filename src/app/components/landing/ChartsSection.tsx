  ...
  const chartSources: ChartSource[] = [
    {
      ...
      tracks: promoTracks.length > 0 ? promoTracks.slice(0, 10) : [
        { id: 'pm-1', position: 1, previousPosition: 3, title: 'Пламя', artist: 'Сандра', plays: 487000, likes: 18200, trend: 'up', trendValue: 2 },
        { id: 'pm-2', position: 2, previousPosition: 1, title: 'Параллели', artist: 'Дэн', plays: 412000, likes: 15600, trend: 'down', trendValue: 1 },
        { id: 'pm-3', position: 3, previousPosition: 0, title: 'Серебро', artist: 'Стелла', plays: 378000, likes: 13400, trend: 'new', trendValue: 0 },
        { id: 'pm-4', position: 4, previousPosition: 2, title: 'На волне', artist: 'Максам', plays: 345000, likes: 11900, trend: 'down', trendValue: 2 },
        { id: 'pm-5', position: 5, previousPosition: 8, title: 'Гравитация', artist: 'Лиана', plays: 312000, likes: 10500, trend: 'up', trendValue: 3 },
        { id: 'pm-6', position: 6, previousPosition: 5, title: 'Контур', artist: 'Марк', plays: 289000, likes: 9800, trend: 'down', trendValue: 1 },
        { id: 'pm-7', position: 7, previousPosition: 0, title: 'Искра', artist: 'Тимур', plays: 256000, likes: 8700, trend: 'new', trendValue: 0 },
        { id: 'pm-8', position: 8, previousPosition: 6, title: 'Эфир', artist: 'Ева', plays: 234000, likes: 7600, trend: 'down', trendValue: 2 },
        { id: 'pm-9', position: 9, previousPosition: 12, title: 'Импульс', artist: 'Роман', plays: 198000, likes: 6200, trend: 'up', trendValue: 3 },
        { id: 'pm-10', position: 10, previousPosition: 7, title: 'Облака', artist: 'Артём', plays: 176000, likes: 5400, trend: 'down', trendValue: 3 },
      ],
    },
    {
      id: 'russkoe',
      ...
      tracks: [
        { id: '1', position: 1, previousPosition: 3, title: 'Не молчи', artist: 'ANNA ASTI', trend: 'up', trendValue: 2 },
        { id: '2', position: 2, previousPosition: 1, title: 'По барам', artist: 'MACAN', trend: 'down', trendValue: 1 },
        { id: '3', position: 3, previousPosition: 0, title: 'Навсегда', artist: 'Zivert', trend: 'new', trendValue: 0 },
        { id: '4', position: 4, previousPosition: 2, title: 'Сияй', artist: 'Мот', trend: 'down', trendValue: 2 },
        { id: '5', position: 5, previousPosition: 7, title: 'Луна', artist: 'Hammali & Navai', trend: 'up', trendValue: 2 },
        { id: '6', position: 6, previousPosition: 5, title: 'Полетели', artist: 'Artik & Asti', trend: 'down', trendValue: 1 },
        { id: '7', position: 7, previousPosition: 0, title: 'Горизонт', artist: 'Jony', trend: 'new', trendValue: 0 },
        { id: '8', position: 8, previousPosition: 6, title: 'Танцуй', artist: 'Дима Билан', trend: 'down', trendValue: 2 },
        { id: '9', position: 9, previousPosition: 4, title: 'Фиолетовый', artist: 'Niletto', trend: 'down', trendValue: 5 },
        { id: '10', position: 10, previousPosition: 13, title: 'Комета', artist: 'Баста', trend: 'up', trendValue: 3 },
      ]
    },
    {
      id: 'nashe',
      ...
      tracks: [
        ...
        { id: '2', position: 2, previousPosition: 4, title: 'Всё идёт по плану', artist: 'Гражданская Оборона', trend: 'up', trendValue: 2 },
        { id: '3', position: 3, previousPosition: 2, title: 'Северный флот', artist: 'Король и Шут', trend: 'down', trendValue: 1 },
        { id: '4', position: 4, previousPosition: 0, title: 'Прощальная', artist: 'Сплин', trend: 'new', trendValue: 0 },
        { id: '5', position: 5, previousPosition: 3, title: 'Районы-кварталы', artist: 'Звери', trend: 'down', trendValue: 2 },
        { id: '6', position: 6, previousPosition: 8, title: 'Мы', artist: 'Би-2', trend: 'up', trendValue: 2 },
        { id: '7', position: 7, previousPosition: 5, title: 'Выхода нет', artist: 'Сплин', trend: 'down', trendValue: 2 },
        { id: '8', position: 8, previousPosition: 0, title: 'Рок-н-ролл мёртв', artist: 'ДДТ', trend: 'new', trendValue: 0 },
        { id: '9', position: 9, previousPosition: 7, title: 'На заре', artist: 'Альянс', trend: 'down', trendValue: 2 },
        { id: '10', position: 10, previousPosition: 6, title: 'Владивосток 2000', artist: 'Мумий Тролль', trend: 'down', trendValue: 4 },
      ]
    },
    {
      id: 'dfm',
      ...
      tracks: [
        { id: '1', position: 1, previousPosition: 2, title: 'Die With A Smile', artist: 'Lady Gaga & Bruno Mars', trend: 'up', trendValue: 1 },
        { id: '2', position: 2, previousPosition: 1, title: 'APT.', artist: 'ROSÉ & Bruno Mars', trend: 'down', trendValue: 1 },
        { id: '3', position: 3, previousPosition: 0, title: 'Abracadabra', artist: 'Lady Gaga', trend: 'new', trendValue: 0 },
        { id: '4', position: 4, previousPosition: 3, title: 'BIRDS OF A FEATHER', artist: 'Billie Eilish', trend: 'down', trendValue: 1 },
        { id: '5', position: 5, previousPosition: 7, title: 'Messy', artist: 'Lola Young', trend: 'up', trendValue: 2 },
        { id: '6', position: 6, previousPosition: 4, title: 'Houdini', artist: 'Dua Lipa', trend: 'down', trendValue: 2 },
        { id: '7', position: 7, previousPosition: 0, title: 'THICK OF IT', artist: 'KSI', trend: 'new', trendValue: 0 },
        { id: '8', position: 8, previousPosition: 5, title: 'Timeless', artist: 'The Weeknd & Playboi Carti', trend: 'down', trendValue: 3 },
        { id: '9', position: 9, previousPosition: 11, title: 'Luther', artist: 'Kendrick Lamar & SZA', trend: 'up', trendValue: 2 },
        { id: '10', position: 10, previousPosition: 8, title: 'Espresso', artist: 'Sabrina Carpenter', trend: 'down', trendValue: 2 },
      ]
    },
    {
      id: 'europa',
      ...
      tracks: [
        { id: '1', position: 1, previousPosition: 2, title: 'Abracadabra', artist: 'Lady Gaga', trend: 'up', trendValue: 1 },
        { id: '2', position: 2, previousPosition: 1, title: 'Die With A Smile', artist: 'Lady Gaga & Bruno Mars', trend: 'down', trendValue: 1 },
        { id: '3', position: 3, previousPosition: 5, title: 'Messy', artist: 'Lola Young', trend: 'up', trendValue: 2 },
        { id: '4', position: 4, previousPosition: 0, title: 'Sympathy Is A Knife', artist: 'Charli XCX', trend: 'new', trendValue: 0 },
        { id: '5', position: 5, previousPosition: 3, title: 'Espresso', artist: 'Sabrina Carpenter', trend: 'down', trendValue: 2 },
        { id: '6', position: 6, previousPosition: 4, title: 'Taste', artist: 'Sabrina Carpenter', trend: 'down', trendValue: 2 },
        { id: '7', position: 7, previousPosition: 9, title: 'Pink Pony Club', artist: 'Chappell Roan', trend: 'up', trendValue: 2 },
        { id: '8', position: 8, previousPosition: 6, title: 'Greedy', artist: 'Tate McRae', trend: 'down', trendValue: 2 },
        { id: '9', position: 9, previousPosition: 0, title: 'Not Like Us', artist: 'Kendrick Lamar', trend: 'new', trendValue: 0 },
        { id: '10', position: 10, previousPosition: 7, title: 'Houdini', artist: 'Dua Lipa', trend: 'down', trendValue: 3 },
      ]
    },
    {
      id: 'yandex',
      ...
      tracks: [
        { id: '1', position: 1, previousPosition: 2, title: 'По барам', artist: 'MACAN', plays: 52340000, likes: 1890000, trend: 'up', trendValue: 1 },
        { id: '2', position: 2, previousPosition: 1, title: 'Люби меня', artist: 'ANNA ASTI', plays: 49870000, likes: 1720000, trend: 'down', trendValue: 1 },
        { id: '3', position: 3, previousPosition: 0, title: 'Тону', artist: 'HOLLYFLAME', plays: 46530000, likes: 1540000, trend: 'new', trendValue: 0 },
        { id: '4', position: 4, previousPosition: 3, title: 'Космонавт', artist: 'Miyagi & Andy Panda', plays: 44120000, likes: 1380000, trend: 'down', trendValue: 1 },
        { id: '5', position: 5, previousPosition: 7, title: 'Сияй', artist: 'MACAN', plays: 41800000, likes: 1250000, trend: 'up', trendValue: 2 },
        { id: '6', position: 6, previousPosition: 4, title: 'Последний танец', artist: 'Макс Корж', plays: 39450000, likes: 1120000, trend: 'down', trendValue: 2 },
        { id: '7', position: 7, previousPosition: 0, title: 'Фиолетовый', artist: 'Niletto', plays: 37200000, likes: 980000, trend: 'new', trendValue: 0 },
        { id: '8', position: 8, previousPosition: 5, title: 'Горизонт', artist: 'Jony', plays: 34900000, likes: 870000, trend: 'down', trendValue: 3 },
        { id: '9', position: 9, previousPosition: 6, title: 'Медляк', artist: 'Скриптонит', plays: 32600000, likes: 760000, trend: 'down', trendValue: 3 },
        { id: '10', position: 10, previousPosition: 12, title: 'Навсегда', artist: 'Zivert', plays: 30200000, likes: 650000, trend: 'up', trendValue: 2 },
      ]
    },
    {
      id: 'shazam',
      ...
      tracks: [
        { id: '1', position: 1, previousPosition: 3, title: 'Abracadabra', artist: 'Lady Gaga', plays: 96000000, trend: 'up', trendValue: 2 },
        { id: '2', position: 2, previousPosition: 1, title: 'Die With A Smile', artist: 'Lady Gaga & Bruno Mars', plays: 91000000, trend: 'down', trendValue: 1 },
        { id: '3', position: 3, previousPosition: 2, title: 'APT.', artist: 'ROSÉ & Bruno Mars', plays: 87000000, trend: 'down', trendValue: 1 },
        { id: '4', position: 4, previousPosition: 0, title: 'Тону', artist: 'HOLLYFLAME', plays: 79000000, trend: 'new', trendValue: 0 },
        { id: '5', position: 5, previousPosition: 4, title: 'Люби меня', artist: 'ANNA ASTI', plays: 72000000, trend: 'down', trendValue: 1 },
        { id: '6', position: 6, previousPosition: 8, title: 'Not Like Us', artist: 'Kendrick Lamar', plays: 66000000, trend: 'up', trendValue: 2 },
        { id: '7', position: 7, previousPosition: 5, title: 'Сияй', artist: 'MACAN', plays: 61000000, trend: 'down', trendValue: 2 },
        { id: '8', position: 8, previousPosition: 0, title: 'Sympathy Is A Knife', artist: 'Charli XCX', plays: 55000000, trend: 'new', trendValue: 0 },
        { id: '9', position: 9, previousPosition: 6, title: 'Espresso', artist: 'Sabrina Carpenter', plays: 49000000, trend: 'down', trendValue: 3 },
        { id: '10', position: 10, previousPosition: 7, title: 'Messy', artist: 'Lola Young', plays: 43000000, trend: 'down', trendValue: 3 },
      ]
    },
  ];

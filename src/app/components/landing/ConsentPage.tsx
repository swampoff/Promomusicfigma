...
const sections: Section[] = [
  {
    ...
    content: [
      ...
      'Контактный email для вопросов по обработке данных: privacy@promo-music.ru.',
  ...
  },
  {
    ...
    icon: FileText,
    content: [
      'Регистрация и идентификация пользователя на платформе ПРОМО.МУЗЫКА.',
  ...
  },
  {
    ...
    content: [
      ...
      'Облачные провайдеры (Yandex Cloud, AWS) — для хранения данных в защищённых дата-центрах.',
  ...
  },
  {
    ...
    content: [
      ...
      'Отозвать настоящее согласие путём направления письменного заявления на privacy@promo-music.ru.',
        ...
        >
          ...
          <div className="space-y-2 text-xs sm:text-sm text-slate-300 leading-relaxed">
            <p>
              ...
              <span className="text-green-400">privacy@promo-music.ru</span>.
            </p>
            <p>
            ...
            <p>
              Принимая данное согласие при регистрации на платформе ПРОМО.МУЗЫКА, Пользователь

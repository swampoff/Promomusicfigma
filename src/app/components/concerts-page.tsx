...
export function ConcertsPage({ userCoins, onCoinsUpdate, onOpenCoinsModal }: ConcertsPageProps) {
  ...
  const demoConcerts: ConcertItem[] = [
    {
      id: 1,
      title: 'Toxi$ — Большой сольный концерт',
      date: '2026-03-14',
      time: '19:00',
      city: 'Москва',
      venue: 'VK Stadium',
      type: 'Арена шоу',
      description: 'Большой сольный концерт Toxi$ на главной площадке столицы',
      banner: '/banners/venues.png',
      ticketPriceFrom: '2000',
      ticketPriceTo: '8000',
      ticketLink: 'https://afisha.yandex.ru/moscow/concert',
    ...
    {
      id: 2,
      title: 'Триумф джаза — XXVI фестиваль',
      date: '2026-03-15',
      time: '19:00',
      city: 'Москва',
      venue: 'Дом музыки',
      type: 'Фестиваль',
      description: 'XXVI Международный фестиваль «Триумф джаза» — день третий',
    ...
    {
      id: 3,
      title: 'МОТ — Большой концерт',
      date: '2026-03-15',
      time: '19:00',
      city: 'Казань',
      venue: 'МВЦ «Казань Экспо»',
      type: 'Клубное выступление',
      description: 'Большой сольный концерт МОТа в Казани',
      banner: '/banners/radio.png',
      ticketPriceFrom: '2000',
      ticketPriceTo: '6000',
      ticketLink: 'https://afisha.yandex.ru/kazan/concert',
    ...
    {
      id: 4,
      title: 'Сергей Бобунец с симфоническим оркестром',
      date: '2026-03-14',
      time: '19:00',
      city: 'Екатеринбург',
      venue: 'МТС Live Холл',
      type: 'Арена шоу',
      description: 'Большой концерт с симфоническим оркестром',
      banner: '/banners/venues.png',
      ticketPriceFrom: '2500',
      ticketPriceTo: '7000',
      ticketLink: 'https://afisha.yandex.ru/yekaterinburg/concert',
    ...
    },
    {
      ...
      type: 'Арена шоу',
      description: 'Грандиозное шоу Полины Гагариной',
      banner: '/banners/artists.png',

  ...
  const demoNews: NewsItem[] = [
    {
      ...
      preview: 'Отправил трек через питчинг на Promo.Music и получил одобрение от радиостанции...',
      content: 'Отправил трек через питчинг на Promo.Music и получил одобрение от радиостанции! Модуль Promo.Air реально работает — трек уже в ротации. Спасибо команде платформы за возможность. Рекомендую всем артистам попробовать.',
      coverImage: 'https://images.unsplash.com/photo-1478737270239-2f02b77fc618?w=800',
      date: '2026-03-08',
      publishDate: new Date('2026-03-08').toISOString(),
    ...
    {
      id: 2,
      title: 'Готовлю новый материал в Promo.Lab',
      preview: 'Попробовал новый модуль Promo.Lab для коллабораций с продюсерами...',
      content: 'Попробовал новый модуль Promo.Lab для коллабораций с продюсерами — нашёл отличного битмейкера прямо на платформе. Работаем над совместным треком, скоро будет готов. AI-помощник для сведения — вообще огонь!',
    ...
    {
      id: 3,
      title: 'Анонс весеннего тура — билеты в продаже',
      preview: 'Объявляю весенний тур по 6 городам России...',
      content: 'Объявляю весенний тур по 6 городам России: Москва, Санкт-Петербург, Казань, Екатеринбург, Краснодар, Новосибирск. Все даты уже добавлены в мой профиль на Promo.Music. Билеты в продаже!',
      coverImage: 'https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?w=800',
      date: '2026-03-03',
      publishDate: new Date('2026-03-03').toISOString(),
    ...
    {
      id: 4,
      title: 'Закулисье студии — запись нового сингла',
      preview: 'Хочу показать вам, как проходит процесс записи...',
      content: 'Хочу показать вам, как проходит процесс записи нового материала. Работаем в студии днём и ночью. Promo.Guide подсказал оптимальное время для релиза — следим за аналитикой!',
      coverImage: 'https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?w=800',
      date: '2026-02-28',
    ...
    },
    {
      ...
      content: 'Запустили линейку официального мерча с новым дизайном! Футболки, худи, кепки — всё с эксклюзивным оформлением. Заказывайте на нашем сайте!',
      coverImage: 'https://images.unsplash.com/photo-1556821840-3a63f95609a7?w=800',
      date: '2026-02-25',
      publishDate: new Date('2026-02-25').toISOString(),

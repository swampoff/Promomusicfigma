    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a14] via-purple-900 to-[#0a0a14] relative">
      ...
      >
        ...
        >
          ...
          <button
            onClick={() => toast.info('Покупка коинов скоро будет доступна')}
            className="w-full p-3 rounded-xl bg-gradient-to-r from-yellow-500/20 to-orange-500/20 border border-yellow-500/30 transition-all duration-300"
          >
            <div className="flex items-center justify-between">
              ...
              <span className="text-yellow-200/40 text-sm">
                Скоро
              </span>
            </div>
          </button>

...
const GENRE_TRACK_TITLES: Record<string, string[]> = {
  ...
  'R&B': ['Бархатная ночь', 'Дотронься', 'Тишина', 'Сладкий яд', 'В тем��оте', 'Осколки', 'Чувствую тебя', 'Шёпот', 'Пульс', 'Без слов'],
  ...
  'Synth-pop': ['Ретро-будущее', 'Неон на��сегда', 'Танцпол 2099', 'Дискотека снов', 'Голограмма', 'VHS Memories', 'Волна', 'Sunset Drive', 'Chrome Heart', 'После полуночи'],
  ...
  'Jazz': ['Midnight Blues', 'Импровизация №5', 'Бархатный вечер', 'Свинг в парке', 'Дождь в Нью-Йорке', 'Сакс��фон и луна', 'Cool Breeze', 'Сладкий ритм', 'Нота души', 'Jam Session'],
  ...
  'Soul': ['Исповедь', 'Глубокое чувство', 'Огонь внутри', 'Сила любви', 'Невыразимое', 'Зол��той час', 'Родная земля', 'Голос сердца', 'Истинная страсть', 'Благодарность'],
};

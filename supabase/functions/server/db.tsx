...
export const audioBrandingOrdersStore = jsonbStore('audio_branding_orders');
export const audioBrandingByStatusStore = jsonbStore('audio_branding_by_status', 'status');
export const audioBrandingByVenueStore = jsonbStore('audio_branding_by_venue', 'venue_id');
export const audioBrandingByArtistStore = jsonbStore('audio_branding_by_artist', 'artist_id');
export const production360OrdersStore = jsonbStore('production_360_orders');
export const production360ByStatusStore = jsonbStore('production_360_by_status', 'status');
export const production360ByArtistStore = jsonbStore('production_360_by_artist', 'artist_id');
...
export const newReleasesStore = jsonbStore('new_releases');
export const radioNewsletterStore = jsonbStore('radio_newsletter');
export const exclusivePitchStore = jsonbStore('exclusive_pitch');
export const radioContactsStore = jsonbStore('radio_contacts');
export const videoModerationStore = jsonbStore('video_moderation');
export const videoNewReleasesStore = jsonbStore('video_new_releases');
export const videoNewsletterStore = jsonbStore('video_newsletter');
export const videoExclusivePitchStore = jsonbStore('video_exclusive_pitch');
export const trackTestNewReleasesStore = jsonbStore('track_test_new_releases');
export const trackTestNewsletterStore = jsonbStore('track_test_newsletter');
export const trackTestExclusivePitchStore = jsonbStore('track_test_exclusive_pitch');
